...
urlpatterns = [
    ...
    path('student-card-list/class/<str:class_id>/',
         views.card_form, name='card_form'),
    ...
    path('export-id-cards/<str:class_id>/',
         views.export_id_cards, name='export_id_cards'),
    path('update-school/', views.update_school, name='update_school'),
    path('update-profile/', views.update_profile, name='update_profile'),
    path('import-data/', views.upload_excel, name="import"),
    path('export-data/', views.export_excel, name='export_excel'),
    path('school-dashbaord/', views.school, name="school_dashboard"),
